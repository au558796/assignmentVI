...
m1 = glmer(diagnosis ~ scale(range) + (1|trial)+(1|id), data = dframe, family = 'binomial')
summary(m1)

m2 = glmer(diagnosis ~ scale(variance) + (1|trial)+(1|id), data = dframe, family = 'binomial')
summary(m2)

m3 = glmer(diagnosis ~ scale(mean) + (1|trial)+(1|id), data = dframe, family = 'binomial')
summary(m3)

##3a. Is study a significant predictor in these models? What should you infer from this? Does study interact with diagnosis? What should you infer from this?

m4 = glmer(diagnosis ~ study + (1|trial) + (1|id), data = dframe, family = 'binomial')
summary(m4)
